  ...
  */  var $, Chosen, get_side_border_padding, root;
  ...
  Chosen = (function() {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      this.title = this.form_field_jq.data('title') ? '<i>' + this.form_field_jq.data('title') + '</i>' : ''; // add 20110801
      container_div = $("<div />", {
      ...
      if (this.is_multiple) {
        ...
        container_div.html('<a href="javascript:void(0)" class="chzn-single">' + this.title + '<span class="' + ( this.title == '' ? '' : 'wtitle' ) + '">' + this.default_text + '</span><div><b></b></div></a><div class="chzn-drop" style="left:-9000px;"><div class="chzn-search"><input type="text" /></div><ul class="chzn-results"></ul></div>');
      }
    ...
    Chosen.prototype.winnow_results = function() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        option = _ref[_i];
        if (!option.empty && !option.disabled) {
			if (option.group) {
            $('#' + option.dom_id).hide();
